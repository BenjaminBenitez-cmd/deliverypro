                ...
                <Col sm={12}>
                    <Card className="card-plain">
                        ...
                        <CardBody>
                            ...
                            <tbody>
                                {
                                    customers && customers.map((node, index) => (
                                        <tr key={index}>
                                            <td>{node.first_name}</td>
                                            <td>{node.last_name}</td>
                                            <td>{node.email}</td>
                                            <td><span className="text-info">{node.pending_deliveries}</span></td>
                                            <td><span className="text-success">{node.completed_deliveries}</span></td>
                                        </tr>
                                    ))                                                                              
                                }
                            </tbody>
